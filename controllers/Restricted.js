...
const addRestrictedUsers = async (req, res) => {
    ...
    console.log("this is the user id here ", user_id)
    ...
    if (isblock) return res.status(200).json({ status: true })
...
const getStaticRestrictedUsers = async (req, res) => {
    ...
    res.status(200).json({
        restricteduser,
        message: "restricted by admin please contact admin for more information",
        isBlock: true
    })
}
